        ...
        <div class="mx-auto flex flex-wrap flex-row items-center justify-between">
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a class="block cursor-pointer nav-1-2{{ Request::is('clubs') ? ' active' : '' }}" href="{{ route('landing.clubs') }}">Clubs</a>

                    <a class="block cursor-pointer nav-1-2{{ Request::is('players') ? ' active' : '' }}" href="{{ route('landing.players') }}">Players</a>

                    <a class="block cursor-pointer nav-1-2{{ Request::is('managers') ? ' active' : '' }}" href="{{ route('landing.managers') }}">Managers</a>

                    <a class="block cursor-pointer nav-1-2{{ Request::is('stadiums') ? ' active' : '' }}" href="{{ route('landing.stadiums') }}">Stadium</a>
                </nav>
            </div>
